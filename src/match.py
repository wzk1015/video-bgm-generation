...
tmp = np.load('lpd_5_prcem_mix_v8_10000.npz', allow_pickle=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', default='wzk.npz', help='Video npz path')
    args = parser.parse_args()

    match_midi(np.load(args.video, allow_pickle=True)['input'])
